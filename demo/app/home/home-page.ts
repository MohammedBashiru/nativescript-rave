...
export function initPayment(args) {
    let context = prepare({
      ...
      fName: "Mohammed",
      lName: "Bashiru",
      email: "mohammedbashiru63@gmail.com",
      narration: "naration here",
      publicKey: "FLWPUBK_TEST-1d441d04304afa8d416e3ea7240b5334-X",
      encryptionKey: "FLWSECK_TEST6056a53c8f80",
      txRef: "txRef",
      amount: 2,
