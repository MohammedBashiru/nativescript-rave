...
export interface PayLoad {
  ...
  /**
   * Set to true if you want to accept Rwanda mobile money payments, else set to false .
   */
  acceptRwfMobileMoneyPayments?: boolean;

  /**
   * Set to true if you want to accept UK Bank Account payments, else set to false .
   */
  acceptUkPayments?: boolean;

  /**
   * Set to true if you want to accept USSD payments, else set to false .
   */
  acceptUssdPayments?: boolean;

  /**
   * Set to true if you want to accept Francophone mobile money payments, else set to false .
   */
